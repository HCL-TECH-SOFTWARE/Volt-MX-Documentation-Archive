...
(function (jtd, undefined) {
  ...
  function initSearch() {
    ...
    request.open('GET', `{{site.searchUrl}}/Volt-MX-Documentation-Archive/assets/js/search-data.json`, true);
    ...
    request.onload = function () {
      if (request.status >= 200 && request.status < 400) {
        ...
        request1.open('GET', '{{site.searchUrl}}/Volt-MX-Documentation-Archive/assets/js/search-index.json', true);
